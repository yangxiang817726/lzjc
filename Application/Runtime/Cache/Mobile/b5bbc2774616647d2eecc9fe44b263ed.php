		...
		<ul>
			...
			<li>
				<a href="<?php echo U('Index/street');?>">
					<img alt="店铺街" src="/Template/mobile/new/Static/images/1440439257667525408.png">
					<span>店铺街</span>
				</a>
			</li>
			<li>
				<a href="<?php echo U('Index/brand');?>">
					<img alt="品牌街" src="/Template/mobile/new/Static/images/1440439281976779943.png">
					<span>品牌街</span>
				</a>
			</li>
			<li>
				<a href="<?php echo U('Activity/discount_list');?>">
					<img alt="优惠活动" src="/Template/mobile/new/Static/images/1440439952487090605.png">
					<span>优惠活动</span>
				</a>
			</li>		 
			<li>
			...
			<li>
				<a href="<?php echo U('User/order_list');?>">
					<img alt="积分商城" src="/Template/mobile/new/Static/images/1440439335793850371.png">
					<span>我的订单</span>
				</a>
			</li>
			<li>
...
*/
	...
	function GetRTime2(){
	   ...
	   <?php
 $md5_key = md5("select * from __PREFIX__goods as g inner join __PREFIX__flash_sale as f on g.goods_id = f.goods_id and g.is_on_sale = 1 and g.goods_state =1 limit 3"); $result_name = $sql_result_v = S("sql_".$md5_key); if(empty($sql_result_v)) { $Model = new \Think\Model(); $result_name = $sql_result_v = $Model->query("select * from __PREFIX__goods as g inner join __PREFIX__flash_sale as f on g.goods_id = f.goods_id and g.is_on_sale = 1 and g.goods_state =1 limit 3"); S("sql_".$md5_key,$sql_result_v,1); } foreach($sql_result_v as $k=>$v): ?>var text<?php echo ($v[goods_id]); ?> = GetRTime('<?php echo (date("Y/m/d H:i:s",$v["end_time"])); ?>');
	            ...
	            <div class="index_pro">
		            <a href="<?php echo U('Mobile/Goods/goodsInfo',array('id'=>$val[goods_id]));?>" title="<?php echo ($val["goods_name"]); ?>"> 
		              <div class="products_kuang">
		                ...
		                <img src="<?php echo (goods_thum_images($val["goods_id"],400,400)); ?>" onerror="this.src='/Template/mobile/new/Static/images/icon_product_null.png'">
		              </div>
  ...
  <div class="floor_body1">
    ...
    <div id="scroll_best" class="scroll_hot">
      <div class="bd">
        ...
        <?php $fl = '1'; ?>
         <?php
 $md5_key = md5("select * from __PREFIX__goods where is_recommend=1 and is_on_sale = 1 and goods_state = 1 order by sort desc limit 9"); $result_name = $sql_result_v = S("sql_".$md5_key); if(empty($sql_result_v)) { $Model = new \Think\Model(); $result_name = $sql_result_v = $Model->query("select * from __PREFIX__goods where is_recommend=1 and is_on_sale = 1 and goods_state = 1 order by sort desc limit 9"); S("sql_".$md5_key,$sql_result_v,1); } foreach($sql_result_v as $k=>$v): ?><li>
  ...
  <div class="floor_body1" >
    ...
    <div id="scroll_new" class="scroll_hot">
      <div class="bd">
        ...
        <?php $fl = '1'; ?>
         <?php
 $md5_key = md5("select * from __PREFIX__goods where is_new=1 and is_on_sale = 1 and goods_state = 1 order by sort desc limit 9"); $result_name = $sql_result_v = S("sql_".$md5_key); if(empty($sql_result_v)) { $Model = new \Think\Model(); $result_name = $sql_result_v = $Model->query("select * from __PREFIX__goods where is_new=1 and is_on_sale = 1 and goods_state = 1 order by sort desc limit 9"); S("sql_".$md5_key,$sql_result_v,1); } foreach($sql_result_v as $k=>$v): ?><li>
            <a href="<?php echo U('Mobile/Goods/goodsInfo',array('id'=>$v[goods_id]));?>" title="<?php echo ($v["goods_name"]); ?>">
             <div class="index_pro"> 
	              <div class="products_kuang">
	                <img src="<?php echo (goods_thum_images($v["goods_id"],400,400)); ?>"></div>
  ...
  <div class="floor_body1" >
    ...
    <div id="scroll_hot" class="scroll_hot">
      <div class="bd">
        ...
        <?php $fl = '1'; ?>
         <?php
 $md5_key = md5("select * from __PREFIX__goods where is_hot=1 and is_on_sale = 1 and goods_state = 1 order by sort desc limit 9"); $result_name = $sql_result_v = S("sql_".$md5_key); if(empty($sql_result_v)) { $Model = new \Think\Model(); $result_name = $sql_result_v = $Model->query("select * from __PREFIX__goods where is_hot=1 and is_on_sale = 1 and goods_state = 1 order by sort desc limit 9"); S("sql_".$md5_key,$sql_result_v,1); } foreach($sql_result_v as $k=>$v): ?><li>
            <a href="<?php echo U('Mobile/Goods/goodsInfo',array('id'=>$v[goods_id]));?>" title="<?php echo ($v["goods_name"]); ?>">
             <div class="index_pro"> 
	              <div class="products_kuang">
	                <img src="<?php echo (goods_thum_images($v["goods_id"],400,400)); ?>"></div>
