                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <?php if(is_array($comment_list)): $i = 0; $__LIST__ = $comment_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td class="text-center">
                                            <img width="20" height="20" src="/Public/images/<?php if($list[is_show] == 1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal2('comment','comment_id','<?php echo ($list["comment_id"]); ?>','is_show',this)"/>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="javascript:void(0);" data-href="<?php echo U('comment/del',array('id'=>$list[comment_id]));?>" onclick="del('<?php echo ($list[comment_id]); ?>',this)" id="button-delete6" data-toggle="tooltip" title="" class="btn btn-danger" data-original-title="删除"><i class="fa fa-trash-o"></i></a>
                                        </td>
