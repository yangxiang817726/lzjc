                                ...
                                <tr>
                                	...
                                	<td colspan="2">
                                	   <div class="col-xs-2">
                                        ...
                                        <div class="col-xs-3">
                                        	<input type="text" placeholder="详细地址" class="form-control" name="store_address" value="<?php echo ($store["store_address"]); ?>" id="address" onclick="dingwei()">
                                        </div>
                                        <div class="col-xs-3">
                                            <input type="text" placeholder="经纬度" class="form-control" name="addressLonglat" value="<?php echo ($store["addresslonglat"]); ?>" id="addressLonglat" onclick="dingwei()">
                                        </div>
                                        <div> <a href="javascript:void(0);" onclick="dingwei()">定位</a></div>
                                	</td>
                                </tr>
                                <tr>
                                    <td>满多少免运费：</td>
...
<script>
    function dingwei(){
        ...
        var district=$("#district option:selected").text(); //获取选中的项
        var addressLonglat=$('#addressLonglat').val();

        var str=province+city+district;
        Getmap(str,addressLonglat,'call_back2');
   }
function adsubmit(){
	$('#handlepost').submit();
}
