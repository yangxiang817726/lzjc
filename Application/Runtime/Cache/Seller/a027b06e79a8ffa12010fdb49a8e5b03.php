                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover" style="font-size:12px;">
                                ...
                                <?php if(is_array($orderList)): $i = 0; $__LIST__ = $orderList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td class="text-center">
                                           <a href="<?php echo U('order/detail',array('order_id'=>$list['order_id']));?>" data-toggle="tooltip" title="" class="btn btn-info" data-original-title="查看详情"><i class="fa fa-eye"></i></a>
                                           <?php if(($list['order_status'] == 3) or ($list['order_status'] == 5)): ?><a href="<?php echo U('order/delete_order',array('order_id'=>$list['order_id']));?>"  data-toggle="tooltip" class="btn btn-danger" title="删除"><i class="fa fa-trash-o"></i></a>
                                           <?php else: ?>
