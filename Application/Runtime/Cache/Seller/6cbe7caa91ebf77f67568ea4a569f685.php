		             ...
		             <table  class="table table-bordered table-striped">
						...
						<tbody>
						  <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr role="row" align="center">
				                     ...
				                     <td>
				                      <a class="btn btn-primary" href="<?php echo U('Admin/role_info',array('group_id'=>$vo['group_id']));?>"><i class="fa fa-pencil"></i></a>
				                      <a class="btn btn-danger" href="javascript:void(0)" data-url="<?php echo U('Admin/roleDel');?>" data-id="<?php echo ($vo["group_id"]); ?>" onclick="delfun(this)"><i class="fa fa-trash-o"></i></a>
									 </td>
