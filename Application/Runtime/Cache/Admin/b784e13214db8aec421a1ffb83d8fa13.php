    ...
    <div class="container-fluid">
      <div class="panel panel-default">
		...
		<div class="navbar navbar-default">                    
                <form id="search-form2" class="navbar-form form-inline"  method="get" action="<?php echo U('store_withdrawals');?>">
                ...
                <div class="form-group">
                  ...
                  <label for="input-order-id" class="control-label">店铺ID:</label>
                  <div class="input-group">
                    <input type="text" class="form-control" id="store_id" placeholder="商家id" value="<?php echo ($_REQUEST['store_id']); ?>" name="store_id" />
                  </div>
          ...
          <div id="ajax_return"> 
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            <thead>
                            <tr>
                                <th class="sorting text-left">申请ID</th>
                                <th class="sorting text-left">店铺id</th>
                            ...
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td class="text-left">
                                        <a href="<?php echo U('Store/store_info',array('store_id'=>$v[store_id]));?>">
                                    ...
                                    <td class="text-left">
                                        <a href="<?php echo U('editStoreWithdrawals',array('id'=>$v['id'],'p'=>$_GET[p]));?>" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="编辑"><i class="fa fa-pencil"></i></a>                                        
		...
		$.ajax({
			...
			success: function(v){	
                            ...
                            if(v.hasOwnProperty('status') && (v.status == 1))
                               location.href='<?php echo U('Admin/Finance/store_withdrawals');?>';
                            else                                
