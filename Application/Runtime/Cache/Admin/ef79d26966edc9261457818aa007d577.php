                        ...
                        <div class="tab-pane active" id="tab_tongyong">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>规格名称：</td>
                                    <td>
                                        <input type="text" value="<?php echo ($spec["name"]); ?>" name="name"  class="form-control" style="width:250px;"/>
                                ...
                                <tr>
                                    <td>排序：</td>
                                    <td>
                                        <input type="text" value="<?php echo ((isset($spec["order"]) && ($spec["order"] !== ""))?($spec["order"]):'50'); ?>" name="order"  class="form-control" style="width:250px;"/>
