        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-list"></i> 属性关联</h3>
                </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span id="err_name" style="color:#F00; display:none;">商品属性名称不能为空!!</span>
                                    </td>
                                </tr>  
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      <div class="col-xs-3">
                                      <select name="cat_id2" id="cat_id2"  class="form-control" style="margin-left:-15px;">
                                        <option value="0">请选择商品分类</option>
                                      </select>  
                                      </div>
                                      <!--<div class="col-xs-3">                        -->
