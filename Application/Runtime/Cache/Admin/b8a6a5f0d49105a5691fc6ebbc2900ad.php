                                ...
                                <tr>
                                    ...
                                    <td >                         		
                                        <select class="form-control" name="auto_confirm_date" id="distribut_date">
                                                <?php $__FOR_START_1183__=1;$__FOR_END_1183__=31;for($i=$__FOR_START_1183__;$i < $__FOR_END_1183__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($config[auto_confirm_date] == $i): ?>selected="selected"<?php endif; ?>><?php echo ($i); ?>天</option><?php } ?>
                                        </select>                                      
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control" name="auto_transfer_date" id="auto_transfer_date">
                                                <?php $__FOR_START_28817__=1;$__FOR_END_28817__=31;for($i=$__FOR_START_28817__;$i < $__FOR_END_28817__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($config[auto_transfer_date] == $i): ?>selected="selected"<?php endif; ?>><?php echo ($i); ?>天</option><?php } ?>
                                        </select>                                      
                                    </td>
                                </tr>                                
                                </tbody> 
