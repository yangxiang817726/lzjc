                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover" style="font-size:12px;">
                                ...
                                <?php if(is_array($orderList)): $i = 0; $__LIST__ = $orderList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td class="text-center"><?php echo ($list["master_order_sn"]); ?></td>
                                        ...
                                        <td><?php echo ($store_list[$list[store_id]]); ?></td>
                                        <td class="text-center">
                                        	...
                                        	<?php else: ?>
                                        		<a href="javascript:void(0)" onclick="alert('该订单不得删除')" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="删除"><i class="fa fa-trash-o"></i></a><?php endif; ?>
                                                 -->
                                        </td>
