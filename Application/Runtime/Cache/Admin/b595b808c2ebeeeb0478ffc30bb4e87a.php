...
<div class="wrapper">
  <header class="main-header">
      ...
      <a href="/index.php/Admin/Index/index" class="logo">
        ...
        <span class="logo-lg"><img src="/Public/images/TP-shop_logo.png" width="40" height="30">&nbsp;&nbsp;<b>吕氏商城</b></span>
      </a>
...
<section class="content-wrapper right-side" id="riframe" style="margin:0px;padding:0px;margin-left:230px;">
	...
	<footer class="main-footer">
	   <div class="pull-right hidden-xs">
	    	 感谢使用ThinkPHP开源系统<b></b>
	   </div>
	   <strong>Copyright &copy; 2015-2025 <a href="">吕氏商城旗下产品</a>.</strong>保留所有权利。
	</footer>
